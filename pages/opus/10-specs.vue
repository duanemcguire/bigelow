    ...
    <client-only>
      <div class="twelve columns">
        <carousel :per-page="1" :mouse-drag="true" :autoplay="true" :autoplay-timeout="7000" :speed="500" :loop="true" :pagination-enabled="true" :autoplay-hover-pause="false" >
          <slide>
            <figure><img src='/images/opus/10/a.jpg'>
              <figcaption>Bigelow & Co. Opus 10 - View 1</figcaption>
            </figure>
          </slide>
          <slide>
            <figure><img src='/images/opus/10/b.jpg'>
              <figcaption>Bigelow & Co. Opus 10 - View 2</figcaption>
            </figure>
          </slide>
        </carousel>
      </div>
